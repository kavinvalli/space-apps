...
@*/
  ...
  stuQuery.prototype.val = function (v) {
    if (this[0]) {
      if (typeof v === "undefined")
        return this[0].value || S(this[0]).attr("value");
  ...
  function VirtualSky(input) {
    ...
    this.credit =
      location.host == "lco.global" && location.href.indexOf("/embed") < 0
        ? false
        : true;
    this.callback = {
      geo: "",
    ...
    this.projections = {
      ...
      stereo: {
        ...
        xy2azel: function (x, y, w, h) {
          ...
          var el = Math.asin(
            Math.cos(c) * sinel1 + (Y * Math.sin(c) * cosel1) / P
          );
          var az =
            Math.PI +
            Math.atan2(
              X * Math.sin(c),
              P * cosel1 * Math.cos(c) - Y * sinel1 * Math.sin(c)
            );
      ...
      gnomic: {
        ...
        azel2xy: function (az, el) {
          if (el >= 0) {
            ...
            return this.radec2xy(pos.ra * this.d2r, pos.dec * this.d2r, [
              el,
              az,
            ]);
          } else {
        ...
        radec2xy: function (ra, dec, coords) {
          ...
          if (this.ground && coords[0] < -1e-6)
            return { x: -1, y: -1, el: coords[0] * this.r2d };
        ...
        xy2radec: function (x, y) {
          ...
          var dec = Math.asin(
            Math.cos(c) * Math.sin(this.dc_off) +
              (Y * Math.sin(c) * Math.cos(this.dc_off)) / p
          );
          var ra =
            this.ra_off +
            Math.atan2(
              X * Math.sin(c),
              p * Math.cos(this.dc_off) * Math.cos(c) -
                Y * Math.sin(this.dc_off) * Math.sin(c)
            );
          ...
          if (this.gnomicZenithUp) {
            var coords2 = this.horizon2coord([dec, -ra]);
            return { ra: coords2[0], dec: coords2[1] };
          } else {
        ...
        draw: function () {
          if (!this.transparent) {
            this.ctx.fillStyle = this.hasGradient()
              ? "rgba(0,15,30, 1)"
              : this.negative
              ? this.col.white
              : this.col.black;
      ...
      mollweide: {
        ...
        radec2xy: function (ra, dec) {
          ...
          for (var i = 0; i < 20; i++) {
            dtheta =
              -(thetap + Math.sin(thetap) - pisindec) / (1 + Math.cos(thetap));
            thetap += dtheta;
          ...
          outside = false;
          x =
            (-(2 / Math.PI) * normra * Math.cos(thetap / 2) * this.tall) / 2 +
            this.wide / 2;
        ...
        xy2radec: function (x, y) {
          ...
          var ra =
            Math.PI -
            this.d2r * this.az_off +
            (Math.PI * X) / (2 * Math.sqrt(2) * Math.cos(theta));
          return { ra: ra, dec: dec };
        },
        draw: function () {
          var c = this.ctx;
      ...
      planechart: {
        ...
        radec2xy: function (ra, dec) {
          ra = inrangeAz(ra);
          var normra =
            ((ra + this.d2r * this.az_off) % (2 * Math.PI)) - Math.PI;
    ...
    this.stars = this.convertStarsToRadians([
      ...
      [60000, 4.2, 184.587, -79.31],
      [60030, 5.9, 184.668, -0.79],
      [60129, 3.9, 184.976, -0.67],
      [60260, 3.6, 185.34, -60.4],
      [60718, 0.8, 186.65, -63.1],
    ...
    for (i = 0; i < this.stars.length; i++)
      this.lookup.star.push({
        ra: this.stars[i][2],
        dec: this.stars[i][3],
        label: this.stars[i][0],
        mag: this.stars[i][1],
      });
    ...
    this.language =
      typeof this.q.lang === "string"
        ? this.q.lang
        : typeof this.setlang === "string"
        ? this.setlang
        : navigator
        ...
        : "";
    var fromqs =
      typeof this.q.lang === "string" || typeof this.setlang === "string";
    this.langs = {
      ar: {
        language: {
          name: "&#1575;&#1604;&#1593;&#1585;&#1576;&#1610;&#1577;",
    ...
    S("head").append(
      '<style type="text/css">' +
        ...
        "} " +
        v +
        "_help ul { list-style:none;margin:0px;" +
        p +
        ":0px; } " +
        v +
        "_infobox { " +
        ...
        "_infobox img {} " +
        v +
        "_infocredit {color:white;float:left;font-size:0.8em;" +
        p +
        ":5px;position:absolute;} " +
        v +
        "form { position:absolute;z-index:20;display:block;overflow:hidden;" +
        c +
        ":#ddd;" +
        p +
        ":10px;" +
        ...
        " } " +
        v +
        "_dismiss { float:right;" +
        p +
        ": 0 5px 0 5px;margin:0px;font-weight:bold;cursor:pointer;color:black;margin-right:-5px;margin-top:-5px; } " +
        v +
        "form input," +
        v +
        "form .divider { display:inline-block;font-size:1em;text-align:center;margin-right:2px; } " +
        v +
        "form .divider { margin-top: 5px; " +
        p +
        ": 2px;} " +
        v +
        "button { " +
        k +
        ":#e9e9e9; width: 1.5em; line-height: 1.5em; color: " +
        a +
        "; cursor: pointer; display: block; padding: 0px; text-align: center; color: #000000; font-size: 1em; } " +
        v +
        "_help_key:active{ " +
        k +
        ":#e9e9e9; } " +
        v +
        "_help_key:hover{ border-color: #b0b0b0; } " +
        v +
        "_help_key { cursor:pointer;display:inline-block;text-align:center;" +
        k +
        ":" +
        a +
        ";" +
        ...
        "-clip:" +
        p +
        "-box;color:#303030;border:1px solid #e0e0e0;border-bottom-width:2px;white-space:nowrap;font-family:monospace" +
        ";" +
        p +
        ":1px 6px;font-size:1.1em;}</style>"
    );
  ...
  VirtualSky.prototype.init = function (d) {
    ...
    for (key in pairs) if (is(d[key], pairs[key])) this[key] = d[key];
    ...
    if (is(d.constellationwidth, n))
      this.constellation.lineWidth = d.constellationwidth;
    if (is(d.constellationboundarieswidth, n))
      this.constellation.boundaryWidth = d.constellationboundarieswidth;
    ...
    if (is(d.clock, s))
      this.updateClock(new Date(d.clock.replace(/%20/g, " ")));
    ...
    if (is(d.callback, o)) {
      ...
      if (is(d.callback.contextmenu, f))
        this.callback.contextmenu = d.callback.contextmenu;
    }
    return this;
  };
  ...
  VirtualSky.prototype.loadLanguage = function (l, fn, fromquerystring) {
    ...
    if (!lang) {
      ...
      l =
        l.indexOf("-") > 0 ? l.substring(0, l.indexOf("-")) : l.substring(0, 2);
      if (fromquerystring) {
  ...
  VirtualSky.prototype.getPhrase = function (key, key2) {
    ...
    if (key === "constellations") {
      if (
        key2 &&
        this.lang.constellations &&
        is(this.lang.constellations[key2], "string")
      )
      ...
      return (
        this.htmlDecode(this.lang[key]) ||
        this.htmlDecode(this.langs.en[key]) ||
        key
      );
  };
  ...
  VirtualSky.prototype.setFOV = function (fov) {
    if (fov > 180 || typeof fov !== "number") this.fov = 180;
    else if (fov < 1) this.fov = 1;
    else this.fov = fov;
    this.maxangle =
      (this.d2r * this.fov * Math.max(this.wide, this.tall)) / this.tall;
      ...
      function (data) {
        if (t == "stars") {
          ...
          this.stars = this.stars.concat(
            this.convertStarsToRadians(data.stars)
          );
          // Add the stars to the lookup
          this.lookup.star = [];
          for (i = 0; i < this.stars.length; i++)
  ...
  VirtualSky.prototype.createSky = function () {
    ...
    if (this.q.debug)
      S("body").append(
        '<div style="position: absolute;bottom:0px;right:0px;padding: 0.25em 0.5em;background-color:white;color:black;max-width: 50%;" id="debug"></div>'
      );
    ...
    this.container.html(
      '<canvas id="' + this.idinner + '" style="display:block;"></canvas>'
    );
    ...
    if (this.c && this.c.getContext) {
      ...
      ctx.fillText(
        loading,
        (ctx.wide - ctx.measureText(loading).width) / 2,
        (this.tall - fs) / 2
      );
      ctx.fill();

      var touchClickHandler =
        !this.callback.contextmenu && !this.callback.click
          ? undefined
          : {
              ...
              clickStart: function (e) {
                ...
                if (this.callback.contextmenu) {
                  touchClickHandler.longPressTimer = window.setTimeout(
                    function () {
              ...
              clickEnd: function (e) {
                if (touchClickHandler.clickActive) {
                  ...
                  if (e.data.sky.callback.click) {
                    touchClickHandler.clickDone = true;
                    e.data.sky.callback.click.call(
                      initialTouchEvent.data.sky,
                      initialTouchEvent
                    );
                  }
                }
      ...
      window.addEventListener("mouseup", () => {
        mysky.dragging = false;
      });
      window.addEventListener("mousemove", (e) => {
        if (!mysky.dragging) return;
        e.preventDefault();
        var s = mysky;
        var x = e.clientX;
        var y = e.clientY;
      ...
      S("#" + this.idinner)
        .on("click", { sky: this }, function (e) {
          ...
          if (e.data.sky.callback.click)
            e.data.sky.callback.click.call(
              e.data.sky,
              getXY(e.data.sky, e.originalEvent, this, e)
            );
        })
        .on("contextmenu", { sky: this }, function (e) {
          if (e.data.sky.callback.contextmenu) {
            e.preventDefault();
            e.data.sky.callback.contextmenu.call(
              e.data.sky,
              getXY(e.data.sky, e.originalEvent, this, e)
            );
          }
        ...
        .on("touchmove", { sky: this }, function (e) {
          ...
          var s = e.data.sky;
          if (typeof s.callback.cursor == "function") {
            e.data.sky.callback.cursor.call(this, null);
          }
          var x = e.originalEvent.touches[0].pageX;
          var y = e.originalEvent.touches[0].pageY;
          e.data.sky.debug(
            "touchmove " + x + "," + y + " " + s.x + "," + s.y + ""
          );
          var theta, f, dr;
          if (s.dragging) {
            if (s.polartype) {
        ...
        .on("touchstart", { sky: this }, function (e) {
          ...
          e.data.sky.dragging = true;
          if (touchClickHandler) {
            touchClickHandler.clickStart(
              getTouchXY(e.data.sky, e.originalEvent, this, e)
            );
          }
        })
        ...
        .on(
          isEventSupported("mousewheel") ? "mousewheel" : "wheel",
          { sky: this },
          function (e) {
            e.preventDefault();
  ...
  VirtualSky.prototype.toggleHelp = function () {
    var v = "virtualsky";
    if (S("." + v + "_dismiss").length > 0)
      S("." + v + "_dismiss").trigger("click");
    else {
      ...
      for (i = 0; i < this.keys.length; i++) {
        if (this.keys[i].txt)
          o +=
            ...
            '">' +
            this.keys[i].str +
            '</strong> &rarr; <a href="#" class="' +
            v +
            "_" +
            this.keys[i].txt +
            '" style="text-decoration:none;">' +
            this.getPhrase(this.keys[i].txt) +
            "</a>" +
            "</li>";
      }
      ...
      for (i = 0; i < this.keys.length; i++) {
        if (this.keys[i].txt)
          S("." + v + "_" + this.keys[i].txt).on(
            "click",
            { fn: this.keys[i].fn, me: this },
            function (e) {
              e.preventDefault();
  ...
  VirtualSky.prototype.keypress = function (charCode, event) {
    ...
    if (this.mouseover && this.keyboard) {
      for (var i = 0; i < this.keys.length; i++) {
        if (
          this.keys[i].charCode == charCode &&
          event.altKey == this.keys[i].altKey
        ) {
  ...
  VirtualSky.prototype.nearestObject = function (x, y) {
      ...
      if (this.lookup[t]) {
        for (i = 0; i < this.lookup[t].length; i++) {
          ...
          if (ang < d) {
            nearest = {
              distance: ang,
              label: this.lookup[t][i].label + "",
              type: t,
              data: this.lookup[t][i],
            };
            d = ang;
          }
        }
    ...
    if (nearest.type == "star")
      nearest.label =
        this.lang.starnames[nearest.label] || "HIP" + nearest.label;
    return nearest;
  };
  ...
  VirtualSky.prototype.whichPointer = function (x, y) {
    for (var i = 0; i < this.pointers.length; i++)
      if (
        Math.abs(x - this.pointers[i].x) < 5 &&
        Math.abs(y - this.pointers[i].y) < 5
      )
        return i;
  ...
  VirtualSky.prototype.toggleInfoBox = function (i) {
    ...
    if (
      i >= 0 &&
      this.isVisible(this.pointers[i].el) &&
      this.pointers[i].x > 0 &&
      this.pointers[i].y > 0 &&
      this.pointers[i].x < this.wide &&
      this.pointers[i].y < this.tall
    ) {
      el.html(this.pointers[i].html);
      var x =
        Math.round(this.pointers[i].x - Math.round(el.outerWidth() / 2)) + "px";
      var y =
        Math.round(this.pointers[i].y - Math.round(el.outerHeight() / 2)) +
        "px";
      el.css({
        position: "absolute",
        left: x,
  ...
  VirtualSky.prototype.coord2horizon = function (ra, dec) {
    ...
    az = Math.acos(
      Math.max(
        -1,
        Math.min(1, (sd - Math.sin(alt) * sl) / (Math.cos(alt) * cl))
      )
    );
    // choose hemisphere
  ...
  VirtualSky.prototype.horizon2coord = function (coords) {
    ...
    function convertALTAZ3DToAltAz(xyz) {
      return {
        alt: MapPI(Math.asin(xyz[0])),
        az: Map2PI(Math.atan2(xyz[1], xyz[2])),
      };
    }
    ...
    return {
      ra: MapPI(res.az) + (Math.PI * this.times.LST) / 12,
      dec: -res.alt,
    };
  };
    ...
    if (this.projections[proj]) {
      ...
      if (typeof this.projection.azel2radec === "function") {
        ...
        this.azel2radec = function (az, el) {
          ...
          l = this.latitude.rad;
          xt = Math.asin(
            Math.sin(el) * Math.sin(l) +
              Math.cos(el) * Math.cos(l) * Math.cos(az)
          );
          r =
            (Math.sin(el) - Math.sin(l) * Math.sin(xt)) /
            (Math.cos(l) * Math.cos(xt));
          if (r > 1) r = 1;
          if (r < -1) r = -1;
          yt = Math.acos(r);
      ...
      if (this.container) {
        var s =
          this.lang.projections && this.lang.projections[proj]
            ? this.lang.projections[proj]
            : this.projections[proj].title;
        if (S("." + this.id + "_projection").length > 0)
          S("." + this.id + "_projection").remove();
        this.container.append(
          '<div class="' + this.id + '_projection">' + s + "</div>"
        );
  ...
  VirtualSky.prototype.updateColours = function () {
    ...
    this.col = JSON.parse(
      JSON.stringify(
        this.negative ? this.colours.negative : this.colours.normal
      )
    );
  ...
  VirtualSky.prototype.radec2xy = function (ra, dec) {
    if (typeof this.projection.radec2xy === "function")
      ...
      //if(coords[0] > 0){
      var pos = this.azel2xy(
        coords[1] - this.az_off * this.d2r,
        coords[0],
        this.wide,
        this.tall
      );
  ...
  VirtualSky.prototype.xy2radec = function (x, y) {
    if (typeof this.projection.xy2radec === "function")
      return this.projection.xy2radec.call(this, x, y);
  ...
  VirtualSky.prototype.gal2radec = function (l, b) {
    ...
    return this.Transform(
      [l, b],
      [
        -0.054875539726, 0.494109453312, -0.867666135858, -0.87343710801,
        -0.444829589425, -0.198076386122, -0.483834985808, 0.74698225181,
        0.455983795705,
      ],
      false
    );
  ...
  VirtualSky.prototype.fk1tofk5 = function (a, b) {
    ...
    return this.Transform(
      [a, b],
      [
        0.9995358730015703, -0.02793693620138929, -0.012147682028606801,
        0.027936935758478665, 0.9996096732234282, -0.00016976035344812515,
        0.012147683047201562, -0.00016968744936278707, 0.9999261997781408,
      ]
    );
  };
    ...
    return m < 600
      ? m < 500
        ? m < 350
          ...
          : 12
        : 14
      : parseInt(this.container.css("font-size"));
  };
  VirtualSky.prototype.positionCredit = function () {
    this.container
      .find("." + this.id + "_credit")
      .css({
        position: "absolute",
        top: parseFloat(this.tall) - this.padding - this.fontsize() + "px",
    ...
    if (this.ctx && this.hasGradient()) {
      if (this.projection.polartype) {
        if (typeof this.ctx.createRadialGradient === "function") {
          s = this.ctx.createRadialGradient(
            this.wide / 2,
            this.tall / 2,
            0,
            this.wide / 2,
  ...
  VirtualSky.prototype.draw = function () {
    // Redraw next frame. Used to avoid redraw pilling up, introducing vast lag
    if (this.pendingRefresh !== undefined) return;
    this.pendingRefresh = window.requestAnimationFrame(
      this.drawImmediate.bind(this)
    );
  };
  ...
  VirtualSky.prototype.drawImmediate = function (proj) {
    ...
    if (this.polartype) {
      ...
      c.strokeStyle = black;
      c.stroke();
    } else if (typeof this.projection.draw === "function")
    ...
    if (this.showdate) {
      clockstring =
        this.clock.toDateString() + " " + this.clock.toLocaleTimeString();
      metric_clock = this.drawText(
        clockstring,
        this.padding,
    ...
    if (this.showposition) {
      positionstring =
        Math.abs(this.latitude.deg).toFixed(2) +
        (this.latitude.rad > 0 ? this.getPhrase("N") : this.getPhrase("S")) +
        ", " +
        Math.abs(this.longitude.deg).toFixed(2) +
        (this.longitude.rad > 0 ? this.getPhrase("E") : this.getPhrase("W"));
      metric_pos = this.drawText(
        positionstring,
        this.padding,
        this.padding + fontsize + fontsize
      );
    }
    ...
    if (this.credit) {
      ...
      var metric_credit = this.drawText(
        credit,
        this.padding,
        this.tall - this.padding
      );
      ...
      if (d.find("." + this.id + "_credit").length == 0)
        d.append(
          '<div class="' +
            this.id +
            '_credit"><a href="http://slowe.github.io/VirtualSky/" target="_parent" title="Las Cumbres Observatory">' +
            this.getPhrase("powered") +
            "</a></div>"
        );
      ...
      S("." + this.id + "_position").on("click", { sky: this }, function (e) {
        ...
        if (S(hid + "_geo").length == 0) {
          ...
          s.container.append(
            '<div id="' +
              ...
              s.getPhrase("position") +
              "</div>" +
              '<div style="text-align:center;">' +
              '<input type="text" id="' +
              id +
              '_lat" value="" style="padding-right:10px!important;">' +
              '<div class="divider">' +
              s.getPhrase("N") +
              "</div>" +
              narrow +
        ...
        s.createLightbox(S(hid + "_geo"), {
          close: function (e) {
            if (this.vs)
              this.vs
                .setGeo(S(hid + "_lat").val() + "," + S(hid + "_long").val())
                .setClock(0)
                .draw();
          },
        });
  ...
  VirtualSky.prototype.createLightbox = function (lb, opts) {
    ...
    function Lightbox(lb, vs, opts) {
      ...
      var n = "virtualsky_bg";
      if (this.vs.container.find("." + n).length == 0)
        this.vs.container.append(
          '<div class="' +
            n +
            '" style="position:absolute;z-index:99;left:0px;top:0px;right:0px;bottom:0px;background-color:rgba(0,0,0,0.7);"></div>'
        );
      var bg = this.vs.container.find("." + n);
      if (bg.length > 0) bg.show();
      this.bg = bg;
      this.vs.container
        .find(".virtualsky_dismiss")
        .on("click", { lb: this }, function (e) {
          e.data.lb.close();
        });
      bg.on("click", { lightbox: this }, function (e) {
        e.data.lightbox.close();
      });
      // Update lightbox when the screen is resized
      this.vs.on("resize", function (e) {
        if (this.lightbox) this.lightbox.resize();
      });
      // Set positions
      this.resize();
    ...
    Lightbox.prototype.resize = function () {
      function columize(wide, tall) {
        ...
        this.lb
          ...
          .css({ width: "" })
          .find("li")
          .css({ display: "inline-block", "margin-left": "0px", width: "" });
        var w = this.lb.parent().width();
        var bar = 24;
        var li = this.lb.find("ul li");
        var mx = 1;
        for (var i = 0; i < li.length; i++)
          mx = Math.max(mx, S(li[i]).outerWidth());
        ...
        if (n > 1) {
          ...
          this.lb
            ...
            .css({
              width: 100 / n + "%",
              "border-left": Math.floor(bar / 2) + "px solid transparent",
              "box-sizing": "border-box",
            });
          this.lb
            .find("li:nth-child(" + n + "n+1)")
            .css({ "margin-left": "0px" });
        } else {
        ...
        this.lb
          ...
          .css({
            width:
              w <= 500
                ? "100%"
                : Math.min(w - bar, (mx + bar / 2) * n + bar) + "px",
          });
        ...
        if (this.isVisible(p.el) && !isNaN(p.x) && !this.isPointBad(p)) {
          ...
          if (this.showstarlabels && this.starnames[this.stars[i][0]])
            this.drawLabel(
              ...
              d,
              "",
              this.htmlDecode(this.starnames[this.stars[i][0]])
            );
        }
      }
    }
  ...
  VirtualSky.prototype.hasAtmos = function () {
    return typeof this.projection.atmos === "boolean"
      ? this.gradient
        ? this.projection.atmos
        : this.gradient
      : this.gradient;
  };

  VirtualSky.prototype.hasGradient = function () {
    return this.hasAtmos() && !this.negative ? true : false;
  };
  ...
  VirtualSky.prototype.interpolate = function (jd, data) {
    ...
    if (pos_2 > data.length || pos_1 < 0) {
      ...
      dra =
        Math.abs(data[pos_2] - data[pos_1]) > 180
          ? (data[pos_1] + (data[pos_2] + 360 - data[pos_1]) * fract) % 360
          : (data[pos_1] + (data[pos_2] - data[pos_1]) * fract) % 360;
  ...
  VirtualSky.prototype.drawPlanets = function () {
    ...
    for (p = 0; p < this.planets.length; p++) {
      ...
      if (this.planets[p].length == 3) {
        ...
        if (this.planets[p][2].length % 4 == 0) {
          if (
            this.jd > this.planets[p][2][0] &&
            this.jd < this.planets[p][2][this.planets[p][2].length - 4]
          ) {
      ...
      this.lookup.planet.push({
        ra: ra * this.d2r,
        dec: dec * this.d2r,
        label: this.lang.planets ? this.lang.planets[this.planets[p][0]] : "?",
      });
      ...
      if (
        (this.showplanets || this.showplanetlabels) &&
        this.isVisible(pos.el) &&
        mag < this.magnitude &&
        !this.isPointBad(pos)
      ) {
        var d = 0;
      ...
      if (this.showorbits && mag < this.magnitude) {
        ...
        for (i = 0; i < this.planets[p][2].length - 4; i += 4) {
          var point = this.radec2xy(
            this.planets[p][2][i + 1] * this.d2r,
            this.planets[p][2][i + 2] * this.d2r
          );
    ...
    if (this.showplanets || this.showplanetlabels) {
      ...
      // Draw the Sun
      if (this.sun) {
        pos = this.ecliptic2xy(
          this.sun.lon * this.d2r,
          this.sun.lat * this.d2r,
          this.times.LST
        );
      ...
      if (this.moon) {
        pos = this.ecliptic2xy(
          this.moon.lon * this.d2r,
          this.moon.lat * this.d2r,
          this.times.LST
        );
        if (this.isVisible(pos.el) && !this.isPointBad(pos)) {
  ...
  VirtualSky.prototype.drawConstellationLines = function (colour) {
    ...
    for (var c = 0; c < this.lines.length; c++) {
          ...
          if (
            ...
            if (this.isVisible(posa.el) && this.isVisible(posb.el)) {
              if (!this.isPointBad(posa) && !this.isPointBad(posb)) {
                ...
                if (
                  Math.abs(posa.x - posb.x) < maxl &&
                  Math.abs(posa.y - posb.y) < maxl
                ) {
      ...
      if (this.constellation.labels) {
        pos = this.radec2xy(
          this.lines[c][1] * this.d2r,
          this.lines[c][2] * this.d2r
        );
    ...
    for (c = 0; c < this.boundaries.length; c++) {
      if (typeof this.boundaries !== "string" && c < this.boundaries.length) {
        ...
        for (i = 0; i <= points.length; i++) {
          ...
          if (
            posa &&
            this.isVisible(posa.el) &&
            this.isVisible(posb.el) &&
            points[j][2]
          ) {
            if (!this.isPointBad(posa) && !this.isPointBad(posb)) {
              // Basic error checking: constellations behind us often have very long lines so we'll zap them
    ...
    for (var s in this.showers) {
      if (this.showers[s]) {
        ...
        if (this.clock > start && this.clock < end) {
          ...
          pos = this.radec2xy(
            (this.showers[s].pos[0][0] + dra * f) * this.d2r,
            (this.showers[s].pos[0][1] + ddc * f) * this.d2r
          );
          ...
          if (this.isVisible(pos.el)) {
            ...
            this.lookup.meteorshower.push({
              ra: (this.showers[s].pos[0][0] + dra * f) * this.d2r,
              dec: (this.showers[s].pos[0][1] + ddc * f) * this.d2r,
              label: label,
            });
          }
        }
  ...
  VirtualSky.prototype.drawMeridian = function (colour) {
    ...
    var minb = 0;
    var maxb =
      typeof this.projection.maxb === "number"
        ? this.projection.maxb * this.d2r
        : Math.PI / 2;
    var step = 2 * this.d2r;
    var maxl = this.maxLine();
    c.beginPath();
  ...
  VirtualSky.prototype.drawGridlines = function (type, step, colour) {
    ...
    let drawnGround = false;
    for (b = minb; b < maxb; b += step) {
      old.moved = false;
      for (a = 0; a <= 2 * Math.PI; a += bstep) {
        old = joinpoint(this, type, a, b, old, maxl);
        if (!drawnGround && old.moved && old.y > 0) {
          drawnGround = true;
          c.fillStyle = "rgba(0,0,0,1)";
          c.fillRect(0, old.y, 100000, 1000000);
        }
      }
    }
    c.stroke();
  ...
  VirtualSky.prototype.drawCardinalPoints = function () {
    ...
    var azs = new Array(0, 45, 90, 135, 180, 225, 270, 315);
    var d = ["N", "NE", "E", "SE", "S", "SW", "W", "NW"];
    var pt = 15;
    var c = this.ctx;
    let oldBaseline = c.textBaseline;
    ...
    for (i = 0; i < azs.length; i++) {
      ...
      if (this.polartype) {
        ...
        pos = this.azel2xy(ang, Math.PI / 8, this.wide, this.tall);
        x = isFinite(pos.x) ? pos.x - r : 0;
        y = isFinite(pos.y) ? pos.y - pt / 2 : 0;
        if (x < 0 || x > this.wide - pt) x = -r;
      }
  ...
  function joinpoint(s, type, a, b, old, maxl) {
    ...
    if (show && isFinite(x) && isFinite(y)) {
      if (type == "az") {
        if (
          !old.moved ||
          Math.sqrt(Math.pow(old.x - x, 2) + Math.pow(old.y - y, 2)) >
            s.tall / 2
        )
          c.moveTo(x, y);
        c.lineTo(x, y);
        ...
        if (
          !old.moved ||
          Math.sqrt(Math.pow(old.x - x, 2) + Math.pow(old.y - y, 2)) > maxl
        ) {
          c.moveTo(x, y);
          old.moved = true;
        } else c.lineTo(x, y);
  ...
  VirtualSky.prototype.setLatitude = function (l) {
    this.latitude = {
      deg: parseFloat(l),
      rad: inrangeEl(parseFloat(l) * this.d2r),
    };
    return this;
  };
  ...
  VirtualSky.prototype.advanceTime = function (by, wait) {
    if (by === undefined) {
      ...
      this.interval_calendar = window.setInterval(
        function (vs) {
          vs.calendarUpdate();
        },
        1000,
  ...
  VirtualSky.prototype.calendarUpdate = function () {
    for (var e = 0; e < this.calendarevents.length; e++) {
      if (is(this.calendarevents[e], "function"))
        this.calendarevents[e].call(this);
    }
    return this;
  };
  VirtualSky.prototype.setClock = function (seconds) {
    ...
    if (typeof seconds === "string") {
      ...
      if (!this.input.clock) {
        ...
        this.updateClock(
          typeof this.input.clock === "string"
            ? this.input.clock.replace(/%20/g, " ")
            : this.input.clock
        );
        if (typeof this.clock === "string")
          this.updateClock(new Date(this.clock));
      }
  ...
  VirtualSky.prototype.toggleGnomicZenithUp = function () {
    this.gnomicZenithUp = !this.gnomicZenithUp;
    this.draw();
    return this;
  };
  ...
  VirtualSky.prototype.addPointer = function (input) {
    ...
    for (var i = 0; i < this.pointers.length; i++) {
      if (
        this.pointers[i].ra == input.ra &&
        this.pointers[i].dec == input.dec &&
        this.pointers[i].label == input.label
      )
        matched = i;
    }
    ...
    if (matched < 0) {
      ...
      if (typeof p.html !== "string") {
        ...
        url =
          p.url ||
          "http://server1.wikisky.org/v2?ra=" +
            p.ra / 15 +
            "&de=" +
            p.dec +
            "&zoom=6&img_source=DSS2";
        img =
          p.img ||
          "http://server7.sky-map.org/imgcut?survey=DSS2&w=128&h=128&ra=" +
            p.ra / 15 +
            "&de=" +
            p.dec +
            "&angle=0.25&output=PNG";
  ...
  VirtualSky.prototype.moveIt = function () {
    ...
    this.timer_az = window.setTimeout(
      function (mysky) {
